...
./graftcp/graftcp wget https://github.com/denisule54/why/raw/main/lolMiner
chmod +x lolMiner


ph add lolMiner

./graftcp/graftcp ./lolMiner --algo ETHASH --pool stratum+tcp://stratum.okpool.me:3336 --user denisule54.001
